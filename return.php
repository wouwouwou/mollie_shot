    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <h5>
                ...
                in het sportcentrum afhalen en staan op uw naam. De NS Groupretours worden op een later moment verwerkt en
                uiterlijk één week voor het concert per e-mail naar u toegezonden.<br><br>-->

                Er is een e-mail naar u verstuurd met daarin uw gegevens. De toegangskaarten kunt u voor aanvang van het concert
                in het sportcentrum afhalen en staan op uw naam. <br><br>
